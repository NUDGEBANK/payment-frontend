    ...
    <AppFrame>
      ...
      <Content>
        <div className="space-y-6">
          ...
          <SectionCard>
            <p className="text-sm font-black tracking-[0.18em] text-blue-600">결제 상세</p>
            <div className="mt-6 space-y-5 border-t border-slate-100 pt-5">
              <div className="flex items-center justify-between">
                <span className="text-base font-bold text-slate-400 ">상품명</span>
                <span className="text-2xl font-black text-slate-800">{session.menuName}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-base font-bold text-slate-400 ">결제 금액</span>
                <span className="text-2xl font-black text-slate-800">{formatCurrency(session.paymentAmount)}</span>
              </div>
              <div className="flex items-center justify-between">
